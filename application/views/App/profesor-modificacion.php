...
<form id="solicitante_form" method="post" name="Form_modificar_profesor"
            ...
            <fieldset style="text-align: left;">
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-9 col-md-9 col-xs-12">
                        ...
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.primer_nombre.$error.required">Campo Requerido</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-9 col-md-9 col-xs-12">
                        ...
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.primer_apellido.$error.required">Campo Requerido</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-6 col-md-6 col-xs-12" style="text-align: left">
                        ...
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.genero.$error.required">Campo Requerido</span>
                 ...
                 <div class="form-group">
                    ...
                    <div class="control-label col-lg-6 col-md-6 col-xs-12">
                        ...
                        <span class="label-red" ng-if=" Form_modificar_profesor.telefono_celular.$error.required">Campo Requerido</span>
                        <span class="label-red" ng-if="Form_modificar_profesor.telefono_celular.$error.pattern">Telefono invalido (04120000000)</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-6 col-md-6 col-xs-12">
                        ...
                        <span class="label-red" ng-if="Form_modificar_profesor.telefono_hab_form.$error.pattern">Telefono invalido (02120000000)</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-9 col-md-9 col-xs-12">
                        <input ng-value="formData.correo_ppal"  ng-model="formData.correo_ppal"  type="email" class="form-control"
                               id="" name="correo"
                               placeholder="juan@xxxx.com" required>
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.correo.$error.required">Campo Requerido</span>
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.correo.$error.email">Correo invalido</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-9 col-md-9 col-xs-12">
                        <input ng-value="formData.correo2"  ng-model="formData.correo2"type="email" class="form-control"
                               ...
                               placeholder="juan@xxxx.com" required>
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.correo_confirme.$error.required">Campo Requerido</span>
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.correo_confirme.$error.email">Correo invalido</span>
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && (!Form_modificar_profesor.correo_confirme.$error.required && !Form_modificar_profesor.correo_confirme.$error.email) && (formData.correo2 != formData.correo_ppal)">Los correos no coinciden</span>
                ...
                <div class="form-group">
                    ...
                    <div class="control-label col-lg-9 col-md-9 col-xs-12">
                        ...
                        <span class="label-red" ng-if="Form_modificar_profesor.$dirty && Form_modificar_profesor.correo_alternativo.$error.email">Correo invalido</span>
        ...
        <div class="panel-footer">
            ...
            <div class="form-group">
                <div id="botoms" class=" col-xs-12  " style="text-align: center;">
                    ...
                    <button  ng-click="Form_modificar_profesor.$valid != false
                                    && (formData.correo2 == formData.correo_ppal)
                                    && !formData.campo_existente ? modificar(formData) : ''" 

                             ng-class="Form_modificar_profesor.$valid != false 
                                       && formData.correo2 == formData.correo_ppal 
