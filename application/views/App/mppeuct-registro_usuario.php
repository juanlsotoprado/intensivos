...
<div class="row animated fadeIn">
    ...
    <form id="solicitante_form" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="control-label col-lg-5 col-md-5 col-xs-12">
                            ...
                            <div class="input-group">
                                ...
                                <input  ng-model="formData.cedula" ng-change="buscar_cedula(formData.cedula);"  min="0"  maxlength="10" ng-minlength="5" ng-maxlength="10"  type="number"  class="form-control" name="cedula" placeholder="Cédula de Identidad" required >
                            </div>
                        </div>
