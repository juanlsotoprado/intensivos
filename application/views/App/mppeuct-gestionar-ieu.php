...
<div class="row animated fadeIn">
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-heading">
            ...
            <h4>Responsables IEU Registrados</h4>
        </div>
                        ...
                        <tbody class="table_bandeja_apro_tbody">
                            <tr ng-repeat="(y,x) in busqueda.usuarios_ieu" >
                                ...
                                <td style="text-align: left;">
                                    ...
                                    <button ng-click="restablecer(x.cedula)" href="javascript:void(0)"  class="btn  btn-xs btn-info">Rest. clave<div class="ripple-container"></div></button>
